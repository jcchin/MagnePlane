\appendix
\subsection{Links to Source Code and Documentation}
\\
\textbf{Source Code:}
\url{https://github.com/NASA-MARTI/MagnePlane}
\\
\textbf{Documentation:}
\url{http://magneplane.readthedocs.io/en/latest/}
\\
\textbf{Wiki:}
\url{https://github.com/NASA-MARTI/MagnePlane/wiki}

\subsection{Model Overview (Continued)}
	\begin{figure}
		\centering
		\includegraphics[width=1\textwidth]{../images/modelOverview.png}
		\caption{Connection diagram for entire system model}
		\label{fig:xdsm:toplevel2}
	\end{figure}}
	...
	\begin{figure}
		...
		\end{tikzpicture}
		\caption{XDSM Diagram Key}
		\label{fig:key}
	\end{figure}

% TODO: Migrate to repo wiki/docs
% \section{TubeGroup}
% 	% \begin{figure}
% 	% 	\centering

\subsubsection{Top Level}
	At the top level, design parameters are passed from the user to the pod, tube, mission, and ticket cost sub-systems. Output variables are then passed back to the user.
	\begin{figure}
		\centering

...
and the distance between pylons as design variables as shown in the equation below,
...
This is reasonable result since, as tube area increases and becomes heavier, larger
...
When analyzing the top level of the system \Cref{fig:pylon_spacing_vs_tube_area}, along

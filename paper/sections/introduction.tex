\paragraph{Motivation}
    ...
    and descending from a cruising altitude and can instead spend more time
    ...
    weather conditions and leverage newer, cleaner propulsion technologies.
    ...
    In order to minimize the tube size, Hyperloop can employ an electrically
    driven compressor in the front of the vehicle to prevent the build up
    ...
    aerodynamic driven design give it qualities more akin to a plane than a train.
    ...
    columns, underground in subterranean tunnels, or in underwater tunnels
    while maintaining a relatively straight trajectory.

...
\nomenclature{$Pr$}{Prandtl Number, $\frac{\nu}{\alpha}$}
...
\nomenclature{$\dot{Q}$}{Heat flow rate ($W$)}
...
\nomenclature{$F_{x}$}{Magnetic Drag ($N$)}
\nomenclature{$m$}{Mass ($kg$)}
\nomenclature{$W_r$}{weighting factor}
\nomenclature{$\lambda$}{Wavelength of Halbach Array ($m$)}
\nomenclature{$w$}{Width of the Magnetic Array ($m$)}
\nomenclature{$\beta_{0}$}{Halbach Peak Strength ($T$)}
\nomenclature{$R$}{Resistance of the Track ($\Omega$)}
\nomenclature{$L$}{Inductance of the Track ($H$)}
\nomenclature{$\omega$}{Frequency of the Induced Current ($Hz$)}
\nomenclature{$H$}{Desired Levitation Height ($m$)} % previously h

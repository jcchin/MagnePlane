...
\author{
  ...
  \and Jeffrey Chin,\thanks{Aerospace Engineer, Propulsion Systems Analysis Branch, Mail Stop 5-10, AIAA Member}
  \and Justin Gray,\thanks{Aerospace Engineer, MDAO Branch,Mail Stop 5-10, AIAA Member}
  \and Christopher Heath,\thanksibid{9}
  \and Kenneth Moore,\thanksibid{9}
  \and Robert Falck,\thanksibid{9}
  \\
  {\normalsize\itshape

...
\author{
  Kenneth Decker,\thanks{Aerospace Engineer, Georgia Insitute of Technology, Aerospace Systems Design Lab}
  \and Jeffrey Chin,\thanks{Aerospace Engineer, Propulsion Systems Analysis Branch, Mail Stop 5-11, AIAA Member}
  \and Andi Peng,\thanks{Computer Scientist, Global Affairs, Yale University}
  ...
  \and Nariman Sharifrazi,\thanks{Aerospace Engineer, Mechanical Engineer, University of California-Irvine}
...
The authors would like to thank the NASA Aeronautics Research Mission
Directorate leadership, as well as Director of Strategy Therese Griebel
and Glenn Academy Director David Kankam for funding the Multidisciplinary
Aeronautics Research Team Initiative (MARTI) program.
Additional thanks to Jerry Welch, Tom Gregory, Isaiah Blankson, Kenneth T Moore,
Keith Marsteller, and Scott Jones for their mentorship and guidance.
...
\nomenclature{$\delta^{*}$}{Boundary layer thickness ($m$)}
...
\nomenclature{$\frac{u}{U}$}{Boundary Velocity Profile}
\nomenclature{$u_{P}$}{Pump uptime per day}
\nomenclature{$x$}{Distance along tube axis (m)}
\nomenclature{$y$}{Distance normal to flow (m)}
...
\nomenclature{$m'$}{Mass per length ($\frac{kg}{m}$)}
\nomenclature{$\mathcal{E}$}{Energy ($J$)}

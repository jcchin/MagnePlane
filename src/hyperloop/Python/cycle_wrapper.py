...
class CycleWrap(ExternalCode):
    ...
    def __init__(self):
        ...
        self.options['command'] = ['runnpss','magneplane.mdl'] #[cmdfile, os.path.join(mydir, 'cycle_NPSS.mdl')]
    ...
    def _setup_communicators(self, comm, pdir):
        ...
        self.npss_output = 'wrapper.out' # output of NPSS, read back into wrapper
...
if __name__ == "__main__":
    ...
    print
    print
    print("BPR", top['des_vars.split:BPR'])
    print("CPR", top['des_vars.cmp25:PR'])
    print("W", top['des_vars.start:W'])

...
class TubeCost(Component):
    def __init__(self):
        ...
        self.add_param('density', 8050.0, desc='density of steel', units='kg/m**3')
        self.add_param('g', 9.81, desc='gravity', units='m/s**2')
        self.add_param('radius', 4.0, desc='tube radius', units='m')
        self.add_param('pod_freq', 30., desc='seconds between departures', units='s')
    ...
    def solve_nonlinear(self, p, u, r):
        ...
        u['tube_thick'] = p['sf']*u['po_tube']*p['radius']/(2*p['stress'])
        u['tube_weight'] = p['density']*pi*u['tube_thick']*(2*p['radius']-u['tube_thick'])

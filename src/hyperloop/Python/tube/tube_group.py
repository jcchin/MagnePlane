...
from hyperloop.Python.tube.tube_wall_temp import TempBalance
...
class TubeGroup(Group):
    def __init__(self):
        ...
        self.add('PropMech', PropulsionMechanics(),promotes=['A',
                                                             ...
                                                             'D_magnetic',
                                                             'Thrust_pod'])
        self.add('TubePower', TubePower(),promotes=[''])

        #Connects vacuum outputs

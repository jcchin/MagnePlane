...
class BasicMotor(Component):
    ...
    def __init__(self):
        ...
        #Designated inputs
        self.add_param('Torque', val=500.0, desc='Output torque', units='N-m')
        ...
        #Desired outputs
        self.add_output('Current', val=0.0, desc='AC `input current magnitude', units='Amps')
...
if __name__== '__main__':
    ...
    print ('Motor Size (Volume) [L]: %f' %prob['comp.Volume'])

...
class Mass(Component):
    def __init__(self):
        ...
        # --- Component Densities
        self.add_param('battery',
                       2100.0,
                       desc='battery density',
                       units='kg/m**3')
        self.add_param('chassis',
                       1.3,
                       desc='chassis material density',
                       units='kg/m**3')
        self.add_param('skin',
                       30.0,
                       desc='skin material density',
                       units='kg/m**3')

        self.add_output('total_mass',
                        0.0,
                        desc='total mass of system',
                        units='kg')
    ...
    def solve_nonlinear(self, params, unknowns, resids):
        ...
        unknowns['total_mass'] = params['battery'] + params[
            'chassis'] + params['skin']

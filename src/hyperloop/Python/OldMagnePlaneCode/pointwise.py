...
class Pointwise(ExternalCode):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.options['command'] = [os.path.join('/Applications', 'Pointwise', 'PointwiseV17.3R4', 'macosx', 'Pointwise.app', 'Contents', 'MacOS', 'tclsh8.5'), os.path.join('..', 'Meshing', 'Pointwise', 'Hyperloop-Mesher.glf')]

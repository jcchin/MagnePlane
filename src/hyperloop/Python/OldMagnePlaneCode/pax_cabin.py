...
class PassengerCapsule(Component):
    ...
    def __init__(self):
        ...
        self.add_param('row_len',
                       1.5,
                       desc='length of each row of seats',
                       units='m')

        self.add_output('capsule_len',
                        0.0,
                        desc='overall length of passenger capsule',
                        units='m')
    ...
    def solve_nonlinear(self, params, unknowns, resids):
        ...
        unknowns['capsule_len'] = 1.1 * params['n_rows'] * params[
            'row_len']  # 10% fudge factor

...
class PropulsionMechanics(Component):
    ...
    ----------
        ...
        tunnel pressure : float
            pressure in the tunnel. Default value is 850 Pa. Will take value from vacuum
        entrance speed : float
            Pod speed when it enters a segment of motors. Default value is 324 m/s.
        Magnetic drag : float
            Drag force on pod from passive maglev. Default value is 335 m/s. Value will come from breakpointlev.py
        Pod Thrust : float
            Thrust generated by pod compressor.  Currently using values from NPSS simulation
